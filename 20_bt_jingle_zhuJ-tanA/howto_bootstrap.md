...
```
- If you plan to use dropdowns, popovers, or tooltips, place the <script> tag for JavaScript bundle (including Popper for positioning dropdowns, poppers, and tooltips) before closing the body:
```
